...
var ainulindale: string = require('./Ainulindale.txt');
var ofTheValar: string = require('./OfTheValar.txt');
var ofTheBeginningOfDays: string = require('./OfTheBeginningOfDays.txt');
